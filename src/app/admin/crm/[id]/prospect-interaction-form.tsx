...
import { Calendar, Mail, Phone, Plus, StickyNote } from "lucide-react";
import { Button } from "@/components/ui/button";
import { Input } from "@/components/ui/input";
import { Textarea } from "@/components/ui/textarea";
import { createProspectInteractionAction } from "@/lib/admin/prospects/actions";
...
export function ProspectInteractionForm({ prospectId }: { prospectId: string }) {
  ...
  const onSubmit = (e: React.FormEvent) => {
    ...
    startTransition(async () => {
      const res = await createProspectInteractionAction({
        prospectId,
        type,
        subject,
        body,
