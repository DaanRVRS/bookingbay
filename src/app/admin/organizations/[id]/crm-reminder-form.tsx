...
import { createReminderAction } from "@/lib/admin/crm/actions";
...
export function CrmReminderForm({
  organizationId,
  admins,
}: {
  ...
  return (
    ...
    >
      <Input
        ...
        maxLength={200}
        placeholder="Titel — bv. 'Bellen over verlenging'"
        required
      />
      ...
      <Textarea
        ...
        rows={2}
        maxLength={2000}
        placeholder="Context (optioneel) — wat is de aanleiding, wat moet je weten…"
      />
